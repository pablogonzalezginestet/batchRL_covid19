...
class Experiment(object): 
    def __init__(self, domain, train_data_file, test_data_file, minibatch_size, rng, device,
        ...
        self.policy_eval_save_file = self.data_folder + '/DQN_policy_eval_rep'
        self.policy_save_file = self.data_folder + '/DQN_policy_rep'
    ...
    def train_DQN_policy(self, pol_learning_rate=1e-3):
        ...
        train_DQN_rep(replay_buffer, self.num_actions, self.hidden_size, self.device, params, behav_pol, self.context_input, test_representations ,test_demog, test_states, test_interventions, test_lengths, test_times, test_rewards,test_dones) # this is trained using the representation
